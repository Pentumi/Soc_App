...
import holeCompetitionRoutes from './routes/holeCompetitions';
...
app.use('/api/tournaments/:tournamentId/games', gameRoutes);
app.use('/api/tournaments/:tournamentId/hole-competitions', holeCompetitionRoutes);
